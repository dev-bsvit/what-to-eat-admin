...
• Убери ТОЛЬКО то, что не является частью имени продукта:
...
КРИТИЧЕСКИ ВАЖНО — НЕ переименовывай:
• Если название уже чистое и конкретное — верни его КАК ЕСТЬ (только переведи если нужно)
• НЕ заменяй специфический продукт на похожий общий
  Примеры запрещённых замен: "Соус цую" → "Соевый соус" ✗, "Дижонская горчица" → "Горчица" ✗,
  "Рисовый уксус" → "Уксус" ✗, "Кокосовое молоко" → "Молоко" ✗
• Соус цую (цую/つゆ) — это самостоятельный японский соус, НЕ соевый соус
