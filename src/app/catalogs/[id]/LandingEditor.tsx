...
- Количество items/pairs/cards в каждой секции — ровно столько, сколько реально нужно для этого каталога: НЕ обрезай до фиксированного числа, НЕ добавляй пустые пункты ради объёма
- КРИТИЧНО: в блоке "translations" каждый массив items/pairs/cards должен содержать РОВНО СТОЛЬКО ЖЕ элементов, сколько в основном блоке — только тексты переведены, id и emoji остаются теми же. Шаблон ниже показывает структуру, а НЕ количество.
