...
ШАГ 1 — ДО генерации JSON напиши ПЛАН (plain text, не JSON):
ПЛАН:
- inside_section: ? пунктов
- audience_section: ? пунктов
- transformation_section: ? пар До/После
- benefits_section: ? карточек
- faq: ? вопросов

ШАГ 2 — Сгенерируй JSON, где каждая секция содержит РОВНО столько элементов, сколько указано в ПЛАНЕ.
В блоке "translations" — ТОЧНО ТАКОЕ ЖЕ количество элементов, что в основном блоке (тексты переведены, id и emoji одинаковые).
