...
- description делай развернутым: 3-5 предложений, 450-750 символов. Опиши что это за блюдо, его происхождение или контекст, вкус, аромат, текстуру, ключевые ингредиенты и почему оно работает как готовый рецепт. Не пиши сухую фразу из одного предложения.
- description должен звучать аппетитно, но без рекламных клише. Пиши конкретно: кислинка, сливочность, хруст, пряность, карамелизация, насыщенный бульон, свежесть трав, мягкость мяса и т.д.
...
- В translations сохраняй тот же уровень подробности: description остаётся развернутым, а instructions остаются простыми шагами-мастер-классом для новичков, а не короткими сухими переводами.
...
- ingredients — массив объектов {id,name,quantity,unit,isMain}. ОБЯЗАТЕЛЬНЫЙ ПОРЯДОК: сначала 1–3 главных ингредиента (белок, база, ключевой овощ) — они идут первыми и получают isMain: true; затем второстепенные (лук, морковь, томатная паста, яйцо, сливки); в конце — вспомогательные (соль, масло, вода, специи, чеснок, зелень) с isMain: false. Примеры главных: курица, говядина, рыба, паста, рис, гречка, картофель, тыква, творог, фасоль. Примеры вспомогательных: соль, масло, вода, чеснок, перец, лавровый лист, уксус, сода. Если UUID продукта неизвестен, ставь id пустым "" и заполняй name.
...
Шаблон:
{
  ...
  "title": "Том ям",
  "description": "Том ям — яркий тайский суп, в котором острота пасты, цитрусовая свежесть лемонграсса и мягкая сливочность кокосового молока собираются в насыщенный, ароматный бульон. Креветки готовятся быстро и остаются нежными, а лайм и зелень добавляют свежий финальный акцент. Это блюдо хорошо показывает баланс тайской кухни: кислое, острое, солёное и слегка сладкое работают вместе, не перебивая друг друга.",
  ...
  "meal_role": ${JSON.stringify(mealRolePlaceholder)},
  "fridge_life_days": ${form.fridge_life_days || 1},
  "mood_tags": ${JSON.stringify(moodTagsPlaceholder)},
  "main_ingredient": "fish",
  "budget_level": 2,
  "season": ${JSON.stringify(seasonPlaceholder)},
  ...
  "steps": [
    ...
    {"text": "Доведите бульон до уверенного кипения и добавьте лемонграсс. Через несколько минут появится свежий цитрусовый аромат — это знак, что бульон начал забирать вкус из трав.", "duration_minutes": 7, "image_url": "https://example.com/step-1.jpg"},
    {"text": "Убавьте огонь до среднего, вмешайте пасту том-ям и влейте кокосовое молоко. Размешивайте до однородного цвета: бульон должен стать пряным, слегка кремовым и ароматным.", "duration_minutes": null, "image_url": "https://example.com/step-2.jpg"},
    {"text": "Добавьте креветки и готовьте 5-7 минут, пока они не станут розовыми и упругими. Не кипятите слишком активно: спокойное слабое кипение сохраняет креветки сочными.", "duration_minutes": 5, "image_url": null}
  ],
  "translations": {
    "en": {
      "title": "Tom Yum",
